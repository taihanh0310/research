...
public class OrderBuilder
{
    ...
    public OrderedItems preparePizza() throws IOException
    {
        ...
        do
        {
            ...
            pizzaandcolddrinkchoice = Integer.parseInt(br.readLine());
                    ...
                    switch (vegpizzachoice)
                    {
                        case 1:
                        {
                            ...
                            switch (cheezepizzasize)
                            {
                                case 1:
                                {
                                    itemsOrder.addItems(new SmallCheeze());
                                    break;
                                }
                                case 2:
                                {
                                    itemsOrder.addItems(new MediumCheeze());
                                    break;
                                }
                                case 3:
                                {
                                    itemsOrder.addItems(new LargeCheeze());
                                    break;
                                }
                                case 4:
                                {
                                    itemsOrder.addItems(new ExtraLargeCheeze());
                                    break;
                                }
                            }
                            break;
                        ...
                        case 2:
                        {
                            ...
                            switch (onionpizzasize)
                            {
                                ...
                                case 2:
                                {
                                    itemsOrder.addItems(new MediumlOnion());
                                    break;
                                }
                                case 3:
                                {
                        ...
                        case 3:
                        {
                            ...
                            switch (masalapizzasize)
                            {
                                ...
                                case 2:
                                {
                                    itemsOrder.addItems(new MediumMasala());
                                    break;
                                }
                                case 3:
                                {
                                    itemsOrder.addItems(new LargeMasala());
                                    break;
                                }
                                case 4:
                                {
                                    itemsOrder.addItems(new ExtraLargeMasala());
                                    break;
                                }
                            }
                            break;
            ...
            switch (coldDrink)
            {
                case 1:
                {
                    ...
                    switch (pepsisize)
                    {
                        ...
                        default:
                        {
                            itemsOrder.addItems(new ExtraLargePepsi());
                            break;
                        }
                    }
                    break;
                ...
                case 2:
                {
                    ...
                    switch (cokesize)
                    {
                        ...
                        case 4:
                        {
                            itemsOrder.addItems(new ExtraLargeCoke());
                            break;
                        }
                    }
                    break;
        ...
        } while (pizzaandcolddrinkchoice != 3);
        return itemsOrder;
    }
}
